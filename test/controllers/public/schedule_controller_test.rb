...
class Public::ScheduleControllerTest < ActionController::TestCase
  ...
  test 'displays xml schedule' do
    get :index, params: { format: :xml, conference_acronym: @conference.acronym }
    assert_response :success
  end

  test 'displays json schedule' do
    get :index, params: { format: :json, conference_acronym: @conference.acronym }
    assert_response :success
  end

  test 'displays ical schedule' do
    get :index, params: { format: :ics, conference_acronym: @conference.acronym }
    assert_response :success
  end

  test 'displays xcal schedule' do
    get :index, params: { format: :xcal, conference_acronym: @conference.acronym }
    assert_response :success
  end

  test 'displays schedule for a day' do
    get :day, params: { day: 0, conference_acronym: @conference.acronym }
    assert_response :success
  end

  test 'displays pdf schedule for a day' do
    get :day, params: { day: 0, conference_acronym: @conference.acronym, format: 'pdf' }
    assert_response :success
  end
